...
@ options passed:  -fpreprocessed fault_handlers.i -D__SAMA5D29__
...
@ -auxbase-strip build/sama5d29_curiosity/production/_ext/285016979/fault_handlers.o
...
.Ltext0:
	...
	.section	.text.undefined_instruction_irq_handler,code
	.align	2
	...
	.arm
	.fpu neon-vfpv4
	.type	undefined_instruction_irq_handler, %function
undefined_instruction_irq_handler:
.LFB0:
	.file 1 "../src/config/sama5d29_curiosity/fault_handlers.c"
	.loc 1 32 1 view -0
	.cfi_startproc
...
.L2:
	.loc 1 33 5 discriminator 1 view .LVU1
	.loc 1 36 5 discriminator 1 view .LVU2
	b	.L2		@
	.cfi_endproc
.LFE0:
	.size	undefined_instruction_irq_handler, .-undefined_instruction_irq_handler
	.section	.text.software_interrupt_irq_handler,code
	.align	2
	.weak	software_interrupt_irq_handler
	.syntax unified
	.arm
	.fpu neon-vfpv4
	.type	software_interrupt_irq_handler, %function
...
.LFB1:
	...
	@ link register save eliminated.
.L5:
	.loc 1 41 5 discriminator 1 view .LVU4
	.loc 1 44 5 discriminator 1 view .LVU5
	b	.L5		@
	.cfi_endproc
.LFE1:
	.size	software_interrupt_irq_handler, .-software_interrupt_irq_handler
	.section	.text.data_abort_irq_handler,code
	.align	2
	.weak	data_abort_irq_handler
	.syntax unified
	.arm
	.fpu neon-vfpv4
	.type	data_abort_irq_handler, %function
...
.LFB2:
	...
	@ link register save eliminated.
.L7:
	.loc 1 49 5 discriminator 1 view .LVU7
	.loc 1 52 5 discriminator 1 view .LVU8
	b	.L7		@
	.cfi_endproc
.LFE2:
	.size	data_abort_irq_handler, .-data_abort_irq_handler
	.section	.text.prefetch_abort_irq_handler,code
	.align	2
	.weak	prefetch_abort_irq_handler
	.syntax unified
	.arm
	.fpu neon-vfpv4
	.type	prefetch_abort_irq_handler, %function
...
.LFB3:
	...
	@ link register save eliminated.
.L9:
	.loc 1 57 5 discriminator 1 view .LVU10
	.loc 1 60 5 discriminator 1 view .LVU11
	b	.L9		@
	.cfi_endproc
.LFE3:
	.size	prefetch_abort_irq_handler, .-prefetch_abort_irq_handler
	.section	.text,code
.Letext0:
...
.LASF11:
	.ascii	"data_abort_irq_handler\000"
.LASF14:
...
.LASF12:
	.ascii	"software_interrupt_irq_handler\000"
.LASF6:
...
.LASF13:
	.ascii	"undefined_instruction_irq_handler\000"
.LASF5:
	.ascii	"long long int\000"
.LASF10:
	.ascii	"prefetch_abort_irq_handler\000"
.LASF3:
	.ascii	"short int\000"
.LASF4:
	.ascii	"long int\000"
.LASF15:
	.ascii	"../src/config/sama5d29_curiosity/fault_handlers.c\000"
.LASF2:
