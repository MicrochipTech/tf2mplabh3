# 1 "../src/config/sama5d29_curiosity/peripheral/matrix/plib_matrix.c"
...
# 1 "<command-line>"
# 1 "../src/config/sama5d29_curiosity/peripheral/matrix/plib_matrix.c"
# 48 "../src/config/sama5d29_curiosity/peripheral/matrix/plib_matrix.c"
...
# 49 "../src/config/sama5d29_curiosity/peripheral/matrix/plib_matrix.c" 2
...
# 50 "../src/config/sama5d29_curiosity/peripheral/matrix/plib_matrix.c" 2
# 64 "../src/config/sama5d29_curiosity/peripheral/matrix/plib_matrix.c"
void Matrix_Initialize(void)
{
    int i;
    uint32_t key;
    ...
    for (i=0; i<3; i++) {
        ((matrix_registers_t*)0xf0018000)->MATRIX_SPSELR[i] = ((uint32_t)(0xFFFFFFFF));
        ((matrix_registers_t*)0xfc03c000)->MATRIX_SPSELR[i] = ((uint32_t)(0xFFFFFFFF));
    }

    key = 0xb6d81c4dU ^ ((sfr_registers_t*)0xf8030000)->SFR_SN1;
    key &= 0xfffffffeU;

    ((sfr_registers_t*)0xf8030000)->SFR_AICREDIR = key | (((uint32_t)(0x1)) << ((uint32_t)(0)));
}
