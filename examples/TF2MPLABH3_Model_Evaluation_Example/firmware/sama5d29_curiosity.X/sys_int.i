# 1 "../src/config/sama5d29_curiosity/system/int/src/sys_int.c"
...
# 1 "<command-line>"
# 1 "../src/config/sama5d29_curiosity/system/int/src/sys_int.c"
# 47 "../src/config/sama5d29_curiosity/system/int/src/sys_int.c"
# 1 "../src/config/sama5d29_curiosity/system/int/sys_int.h" 1
# 60 "../src/config/sama5d29_curiosity/system/int/sys_int.h"
# 1 "c:\\program files\\microchip\\xc32\\v4.60\\pic32c\\include\\musl\\stdbool.h" 1 3 4
# 61 "../src/config/sama5d29_curiosity/system/int/sys_int.h" 2
...
# 48 "../src/config/sama5d29_curiosity/system/int/src/sys_int.c" 2
# 1 "../src/config/sama5d29_curiosity/peripheral/aic/plib_aic.h" 1
# 48 "../src/config/sama5d29_curiosity/peripheral/aic/plib_aic.h"
...
# 49 "../src/config/sama5d29_curiosity/peripheral/aic/plib_aic.h" 2
...
# 49 "../src/config/sama5d29_curiosity/system/int/src/sys_int.c" 2
# 71 "../src/config/sama5d29_curiosity/system/int/src/sys_int.c"
...
# 77 "../src/config/sama5d29_curiosity/system/int/src/sys_int.c" 3 4
_Bool

# 78 "../src/config/sama5d29_curiosity/system/int/src/sys_int.c"
SYS_INT_IsEnabled( void )
{
    
# 80 "../src/config/sama5d29_curiosity/system/int/src/sys_int.c" 3 4
   _Bool 
# 80 "../src/config/sama5d29_curiosity/system/int/src/sys_int.c"
        retval = 
# 80 "../src/config/sama5d29_curiosity/system/int/src/sys_int.c" 3 4
                 1
# 80 "../src/config/sama5d29_curiosity/system/int/src/sys_int.c"
    ...
    if(( (1UL << 7U) & __get_CPSR() ) != 0U)
    {
        retval = 
# 84 "../src/config/sama5d29_curiosity/system/int/src/sys_int.c" 3 4
                0
# 84 "../src/config/sama5d29_curiosity/system/int/src/sys_int.c"
                     ;
    }
    return( retval );
}
...
# 95 "../src/config/sama5d29_curiosity/system/int/src/sys_int.c" 3 4
_Bool

# 96 "../src/config/sama5d29_curiosity/system/int/src/sys_int.c"
SYS_INT_Disable( void )
{
...
void
SYS_INT_Restore( 
# 102 "../src/config/sama5d29_curiosity/system/int/src/sys_int.c" 3 4
               _Bool 
# 102 "../src/config/sama5d29_curiosity/system/int/src/sys_int.c"
                    state )
{
...
# 107 "../src/config/sama5d29_curiosity/system/int/src/sys_int.c" 3 4
_Bool

# 108 "../src/config/sama5d29_curiosity/system/int/src/sys_int.c"
SYS_INT_SourceIsEnabled( INT_SOURCE aSrcSelection )
{
    
# 110 "../src/config/sama5d29_curiosity/system/int/src/sys_int.c" 3 4
   _Bool 
# 110 "../src/config/sama5d29_curiosity/system/int/src/sys_int.c"
        retval = 
# 110 "../src/config/sama5d29_curiosity/system/int/src/sys_int.c" 3 4
                 0
# 110 "../src/config/sama5d29_curiosity/system/int/src/sys_int.c"
...
# 112 "../src/config/sama5d29_curiosity/system/int/src/sys_int.c" 3 4
   _Bool 
# 112 "../src/config/sama5d29_curiosity/system/int/src/sys_int.c"
    ...
    {
        retval = 
# 116 "../src/config/sama5d29_curiosity/system/int/src/sys_int.c" 3 4
                1
# 116 "../src/config/sama5d29_curiosity/system/int/src/sys_int.c"
                    ;
    }
...
void
SYS_INT_SourceEnable( INT_SOURCE aSrcSelection )
{
    aic_registers_t * aicPtr = laicInstanceGet( aSrcSelection );
    
# 126 "../src/config/sama5d29_curiosity/system/int/src/sys_int.c" 3 4
   _Bool 
# 126 "../src/config/sama5d29_curiosity/system/int/src/sys_int.c"
        processorStatus = SYS_INT_Disable();
    aicPtr->AIC_SSR = ((((uint32_t)(0x7F)) << ((uint32_t)(0))) & (((uint32_t)((uint32_t) aSrcSelection)) << ((uint32_t)(0))));
...
# 133 "../src/config/sama5d29_curiosity/system/int/src/sys_int.c" 3 4
_Bool

# 134 "../src/config/sama5d29_curiosity/system/int/src/sys_int.c"
SYS_INT_SourceDisable( INT_SOURCE source )
{
    
# 136 "../src/config/sama5d29_curiosity/system/int/src/sys_int.c" 3 4
   _Bool 
# 136 "../src/config/sama5d29_curiosity/system/int/src/sys_int.c"
        previousValue = SYS_INT_SourceIsEnabled( source );
    aic_registers_t * aicPtr = laicInstanceGet( source );
    
# 138 "../src/config/sama5d29_curiosity/system/int/src/sys_int.c" 3 4
   _Bool 
# 138 "../src/config/sama5d29_curiosity/system/int/src/sys_int.c"
        processorStatus = SYS_INT_Disable();
    aicPtr->AIC_SSR = ((((uint32_t)(0x7F)) << ((uint32_t)(0))) & (((uint32_t)((uint32_t) source)) << ((uint32_t)(0))));
...
void
SYS_INT_SourceRestore( INT_SOURCE source, 
# 148 "../src/config/sama5d29_curiosity/system/int/src/sys_int.c" 3 4
                                        _Bool 
# 148 "../src/config/sama5d29_curiosity/system/int/src/sys_int.c"
                                             status )
{
    if( status )
    {
...
# 153 "../src/config/sama5d29_curiosity/system/int/src/sys_int.c" 3 4
       _Bool 
# 153 "../src/config/sama5d29_curiosity/system/int/src/sys_int.c"
            processorStatus = SYS_INT_Disable();
        aicPtr->AIC_SSR = ((((uint32_t)(0x7F)) << ((uint32_t)(0))) & (((uint32_t)((uint32_t) source)) << ((uint32_t)(0))));
        aicPtr->AIC_IECR = ((uint32_t)(0x00000001));
        SYS_INT_Restore(processorStatus);
...
# 161 "../src/config/sama5d29_curiosity/system/int/src/sys_int.c" 3 4
_Bool

# 162 "../src/config/sama5d29_curiosity/system/int/src/sys_int.c"
SYS_INT_SourceStatusGet( INT_SOURCE aSrcSelection )
{
    
# 164 "../src/config/sama5d29_curiosity/system/int/src/sys_int.c" 3 4
   _Bool 
# 164 "../src/config/sama5d29_curiosity/system/int/src/sys_int.c"
        retval = 
# 164 "../src/config/sama5d29_curiosity/system/int/src/sys_int.c" 3 4
                 0
# 164 "../src/config/sama5d29_curiosity/system/int/src/sys_int.c"
    ...
    {
        uint32_t regValue = 0;
        uint32_t regSelection = (uint32_t)aSrcSelection >> 5;
        uint32_t bitSelection = (uint32_t)aSrcSelection - (regSelection << 5);
        aic_registers_t * aicPtr = laicInstanceGet( aSrcSelection );
        
# 171 "../src/config/sama5d29_curiosity/system/int/src/sys_int.c" 3 4
       _Bool 
# 171 "../src/config/sama5d29_curiosity/system/int/src/sys_int.c"
            processorStatus = SYS_INT_Disable();
        aicPtr->AIC_SSR = ((((uint32_t)(0x7F)) << ((uint32_t)(0))) & (((uint32_t)((uint32_t) aSrcSelection)) << ((uint32_t)(0))));
        switch( regSelection )
        {
        ...
        {
            retval = 
# 192 "../src/config/sama5d29_curiosity/system/int/src/sys_int.c" 3 4
                    1
# 192 "../src/config/sama5d29_curiosity/system/int/src/sys_int.c"
                        ;
        }
    }
    return( retval );
...
void
SYS_INT_SourceStatusSet( INT_SOURCE aSrcSelection )
{
    aic_registers_t * aicPtr = laicInstanceGet( aSrcSelection );
    
# 202 "../src/config/sama5d29_curiosity/system/int/src/sys_int.c" 3 4
   _Bool 
# 202 "../src/config/sama5d29_curiosity/system/int/src/sys_int.c"
        processorStatus = SYS_INT_Disable();
    aicPtr->AIC_SSR = ((((uint32_t)(0x7F)) << ((uint32_t)(0))) & (((uint32_t)((uint32_t) aSrcSelection)) << ((uint32_t)(0))));
    aicPtr->AIC_ISCR = ((uint32_t)(0x00000001));
    SYS_INT_Restore(processorStatus);
    return;
}

void
SYS_INT_SourceStatusClear( INT_SOURCE aSrcSelection )
{
    aic_registers_t * aicPtr = laicInstanceGet( aSrcSelection );
    
# 213 "../src/config/sama5d29_curiosity/system/int/src/sys_int.c" 3 4
   _Bool 
# 213 "../src/config/sama5d29_curiosity/system/int/src/sys_int.c"
        processorStatus = SYS_INT_Disable();
    aicPtr->AIC_SSR = ((((uint32_t)(0x7F)) << ((uint32_t)(0))) & (((uint32_t)((uint32_t) aSrcSelection)) << ((uint32_t)(0))));
    aicPtr->AIC_ICCR = ((uint32_t)(0x00000001));
    SYS_INT_Restore(processorStatus);
    return;
}
