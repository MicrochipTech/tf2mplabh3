# 1 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart0.c"
...
# 1 "<command-line>"
# 1 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart0.c"
# 41 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart0.c"
...
# 42 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart0.c" 2
...
# 44 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart_common.h"
...
# 45 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart_common.h" 2
# 1 "c:\\program files\\microchip\\xc32\\v4.60\\pic32c\\include\\musl\\stdbool.h" 1 3 4
# 46 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart_common.h" 2
...
# 43 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart0.c" 2
...
# 44 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart0.c" 2
...
static void UART0_ErrorClear( void )
{
    ...
    ((uart_registers_t*)0xf801c000)->UART_CR = (((uint32_t)(0x1)) << ((uint32_t)(8)));


    while( (((uint32_t)(0x1)) << ((uint32_t)(0))) == (((uart_registers_t*)0xf801c000)->UART_SR & (((uint32_t)(0x1)) << ((uint32_t)(0)))) )
    {
        dummyData = (uint8_t)(((uart_registers_t*)0xf801c000)->UART_RHR & (((uint32_t)(0xFF)) << ((uint32_t)(0))));
    }
...
void UART0_Initialize( void )
{
    ...
    ((uart_registers_t*)0xf801c000)->UART_CR = ((((uint32_t)(0x1)) << ((uint32_t)(2))) | (((uint32_t)(0x1)) << ((uint32_t)(3))) | (((uint32_t)(0x1)) << ((uint32_t)(8))));


    ((uart_registers_t*)0xf801c000)->UART_CR = ((((uint32_t)(0x1)) << ((uint32_t)(6))) | (((uint32_t)(0x1)) << ((uint32_t)(4))));


    ((uart_registers_t*)0xf801c000)->UART_MR = (((((uint32_t)(0x0)) << ((uint32_t)(12)))) | ((((uint32_t)(0x4)) << ((uint32_t)(9)))) | (0U << ((uint32_t)(4))));


    ((uart_registers_t*)0xf801c000)->UART_BRGR = ((((uint32_t)(0xFFFF)) << ((uint32_t)(0))) & (((uint32_t)(45)) << ((uint32_t)(0))));
}

UART_ERROR UART0_ErrorGet( void )
{
    UART_ERROR errors = (0U);
    uint32_t status = ((uart_registers_t*)0xf801c000)->UART_SR;

    errors = (UART_ERROR)(status & ((((uint32_t)(0x1)) << ((uint32_t)(5))) | (((uint32_t)(0x1)) << ((uint32_t)(7))) | (((uint32_t)(0x1)) << ((uint32_t)(6)))));
...
# 98 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart0.c" 3 4
_Bool 
# 98 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart0.c"
    UART0_SerialSetup( UART_SERIAL_SETUP *setup, uint32_t srcClkFreq )
{
    
# 100 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart0.c" 3 4
   _Bool 
# 100 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart0.c"
        status = 
# 100 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart0.c" 3 4
                 0
# 100 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart0.c"
    ...
    if (setup != 
# 105 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart0.c" 3 4
                ((void *)0)
# 105 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart0.c"
                    )
    {
        baud = setup->baudRate;
        if(srcClkFreq == 0U)
        {
            srcClkFreq = (uint32_t)(83000000UL);
        }
        ...
        if (brgVal <= 65535U)
        {
            ...
            uartMode = ((uart_registers_t*)0xf801c000)->UART_MR;
            uartMode &= ~(((uint32_t)(0x7)) << ((uint32_t)(9)));
            ((uart_registers_t*)0xf801c000)->UART_MR = uartMode | setup->parity ;


            ((uart_registers_t*)0xf801c000)->UART_BRGR = ((((uint32_t)(0xFFFF)) << ((uint32_t)(0))) & (((uint32_t)(brgVal)) << ((uint32_t)(0))));

            status = 
# 127 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart0.c" 3 4
                    1
# 127 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart0.c"
                        ;
        }
    }
...
# 134 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart0.c" 3 4
_Bool 
# 134 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart0.c"
    UART0_Read( void *buffer, const size_t size )
{
    
# 136 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart0.c" 3 4
   _Bool 
# 136 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart0.c"
        status = 
# 136 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart0.c" 3 4
                 0
# 136 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart0.c"
    ...
    if(
# 143 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart0.c" 3 4
      ((void *)0) 
# 143 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart0.c"
           != lBuffer)
    {
        ...
        while( size > processedSize )
        {
            ...
            errorStatus = (((uart_registers_t*)0xf801c000)->UART_SR & ((((uint32_t)(0x1)) << ((uint32_t)(5))) | (((uint32_t)(0x1)) << ((uint32_t)(6))) | (((uint32_t)(0x1)) << ((uint32_t)(7)))));
            ...
            if((((uint32_t)(0x1)) << ((uint32_t)(0))) == (((uart_registers_t*)0xf801c000)->UART_SR & (((uint32_t)(0x1)) << ((uint32_t)(0)))))
            {
                *lBuffer++ = (uint8_t)(((uart_registers_t*)0xf801c000)->UART_RHR& (((uint32_t)(0xFF)) << ((uint32_t)(0))));
                processedSize++;
            }
        }
        ...
        {
            status = 
# 173 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart0.c" 3 4
                    1
# 173 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart0.c"
                        ;
        }
    }
...
# 180 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart0.c" 3 4
_Bool 
# 180 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart0.c"
    UART0_Write( void *buffer, const size_t size )
{
    
# 182 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart0.c" 3 4
   _Bool 
# 182 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart0.c"
        status = 
# 182 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart0.c" 3 4
                 0
# 182 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart0.c"
    ...
    if(
# 186 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart0.c" 3 4
      ((void *)0) 
# 186 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart0.c"
           != lBuffer)
    {
        while( size > processedSize )
        {
            if((((uint32_t)(0x1)) << ((uint32_t)(1))) == (((uart_registers_t*)0xf801c000)->UART_SR & (((uint32_t)(0x1)) << ((uint32_t)(1)))))
            {
                ((uart_registers_t*)0xf801c000)->UART_THR = (((((uint32_t)(0xFF)) << ((uint32_t)(0))) & (((uint32_t)(*lBuffer++)) << ((uint32_t)(0)))) & (((uint32_t)(0xFF)) << ((uint32_t)(0))));
                processedSize++;
            }
        }

        status = 
# 197 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart0.c" 3 4
                1
# 197 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart0.c"
                    ;
    }
...
int UART0_ReadByte(void)
{
    uint32_t readbyte = (((uart_registers_t*)0xf801c000)->UART_RHR& (((uint32_t)(0xFF)) << ((uint32_t)(0))));
    return (int)readbyte;
}

void UART0_WriteByte( int data )
{
    while ((((uart_registers_t*)0xf801c000)->UART_SR & (((uint32_t)(0x1)) << ((uint32_t)(1)))) == 0U)
    {

    }

    ((uart_registers_t*)0xf801c000)->UART_THR = (((((uint32_t)(0xFF)) << ((uint32_t)(0))) & (((uint32_t)(data)) << ((uint32_t)(0)))) & (((uint32_t)(0xFF)) << ((uint32_t)(0))));
}


# 219 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart0.c" 3 4
_Bool 
# 219 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart0.c"
    UART0_TransmitterIsReady( void )
{
    
# 221 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart0.c" 3 4
   _Bool 
# 221 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart0.c"
        status = 
# 221 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart0.c" 3 4
                 0
# 221 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart0.c"
    ...
    {
        status = 
# 225 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart0.c" 3 4
                1
# 225 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart0.c"
                    ;
    }
...
# 231 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart0.c" 3 4
_Bool 
# 231 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart0.c"
    UART0_ReceiverIsReady( void )
{
    
# 233 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart0.c" 3 4
   _Bool 
# 233 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart0.c"
        status = 
# 233 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart0.c" 3 4
                 0
# 233 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart0.c"
    ...
    {
        status = 
# 237 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart0.c" 3 4
                1
# 237 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart0.c"
                    ;
    }
...
# 244 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart0.c" 3 4
_Bool 
# 244 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart0.c"
    UART0_TransmitComplete( void )
{
    
# 246 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart0.c" 3 4
   _Bool 
# 246 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart0.c"
        status = 
# 246 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart0.c" 3 4
                 0
# 246 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart0.c"
    ...
    if((((uint32_t)(0x1)) << ((uint32_t)(9))) == (((uart_registers_t*)0xf801c000)->UART_SR & (((uint32_t)(0x1)) << ((uint32_t)(9)))))
    {
        status = 
# 250 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart0.c" 3 4
                1
# 250 "../src/config/sama5d29_curiosity/peripheral/uart/plib_uart0.c"
                    ;
    }
