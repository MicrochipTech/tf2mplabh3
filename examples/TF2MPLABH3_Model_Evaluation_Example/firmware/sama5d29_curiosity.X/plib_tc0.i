# 1 "../src/config/sama5d29_curiosity/peripheral/tc/plib_tc0.c"
...
# 1 "<command-line>"
# 1 "../src/config/sama5d29_curiosity/peripheral/tc/plib_tc0.c"
# 54 "../src/config/sama5d29_curiosity/peripheral/tc/plib_tc0.c"
...
# 55 "../src/config/sama5d29_curiosity/peripheral/tc/plib_tc0.c" 2
...
# 57 "../src/config/sama5d29_curiosity/peripheral/tc/plib_tc_common.h"
...
# 58 "../src/config/sama5d29_curiosity/peripheral/tc/plib_tc_common.h" 2
# 1 "c:\\program files\\microchip\\xc32\\v4.60\\pic32c\\include\\musl\\stdbool.h" 1 3 4
# 59 "../src/config/sama5d29_curiosity/peripheral/tc/plib_tc_common.h" 2
...
# 56 "../src/config/sama5d29_curiosity/peripheral/tc/plib_tc0.c" 2
...
# 57 "../src/config/sama5d29_curiosity/peripheral/tc/plib_tc0.c" 2
# 65 "../src/config/sama5d29_curiosity/peripheral/tc/plib_tc0.c"
...
void TC0_CH0_TimerInitialize (void)
{
    ...
    ((tc_registers_t*)0xf800c000)->TC_CHANNEL[0].TC_EMR = (((uint32_t)(0x1)) << ((uint32_t)(8)));

    ((tc_registers_t*)0xf800c000)->TC_CHANNEL[0].TC_CMR = (((uint32_t)(0x2)) << ((uint32_t)(13))) | (((uint32_t)(0x1)) << ((uint32_t)(15))) ;


    ((tc_registers_t*)0xf800c000)->TC_CHANNEL[0].TC_RC = 82999U;



    ((tc_registers_t*)0xf800c000)->TC_CHANNEL[0].TC_IER = (((uint32_t)(0x1)) << ((uint32_t)(2)));
    TC0_CH0_CallbackObj.callback_fn = 
# 81 "../src/config/sama5d29_curiosity/peripheral/tc/plib_tc0.c" 3 4
                                     ((void *)0)
# 81 "../src/config/sama5d29_curiosity/peripheral/tc/plib_tc0.c"
                                         ;
}
...
void TC0_CH0_TimerStart (void)
{
    ((tc_registers_t*)0xf800c000)->TC_CHANNEL[0].TC_CCR = ((((uint32_t)(0x1)) << ((uint32_t)(0))) | (((uint32_t)(0x1)) << ((uint32_t)(2))));
}


void TC0_CH0_TimerStop (void)
{
    ((tc_registers_t*)0xf800c000)->TC_CHANNEL[0].TC_CCR = ((((uint32_t)(0x1)) << ((uint32_t)(1))));
}
...
void TC0_CH0_TimerPeriodSet (uint32_t period)
{
    ((tc_registers_t*)0xf800c000)->TC_CHANNEL[0].TC_RC = period;
}


void TC0_CH0_TimerCompareSet (uint32_t compare)
{
    ((tc_registers_t*)0xf800c000)->TC_CHANNEL[0].TC_RA = compare;
}


uint32_t TC0_CH0_TimerPeriodGet (void)
{
    return (uint32_t)((tc_registers_t*)0xf800c000)->TC_CHANNEL[0].TC_RC;
}


uint32_t TC0_CH0_TimerCounterGet (void)
{
    return (uint32_t)((tc_registers_t*)0xf800c000)->TC_CHANNEL[0].TC_CV;
}
...
{
    TC_TIMER_STATUS timer_status = (TC_TIMER_STATUS)(((tc_registers_t*)0xf800c000)->TC_CHANNEL[0].TC_SR & ((((uint32_t)(0x1)) << ((uint32_t)(2))) | (((uint32_t)(0x1)) << ((uint32_t)(4)))));


    uintptr_t context = TC0_CH0_CallbackObj.context;


    if ((TC0_CH0_CallbackObj.callback_fn != 
# 141 "../src/config/sama5d29_curiosity/peripheral/tc/plib_tc0.c" 3 4
                                           ((void *)0)
# 141 "../src/config/sama5d29_curiosity/peripheral/tc/plib_tc0.c"
                                               ) && ((0U) != timer_status))
    {
        TC0_CH0_CallbackObj.callback_fn(timer_status, context);
    }
}
# 162 "../src/config/sama5d29_curiosity/peripheral/tc/plib_tc0.c"
