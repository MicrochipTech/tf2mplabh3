# 1 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
...
# 1 "<command-line>"
# 1 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
# 49 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
# 1 "c:\\program files\\microchip\\xc32\\v4.60\\pic32c\\include\\musl\\string.h" 1 3 4
...
# 9 "c:\\program files\\microchip\\xc32\\v4.60\\pic32c\\include\\musl\\string.h" 2 3 4
# 23 "c:\\program files\\microchip\\xc32\\v4.60\\pic32c\\include\\musl\\string.h" 3 4
...
# 112 "c:\\program files\\microchip\\xc32\\v4.60\\pic32c\\include\\musl\\bits\\alltypes.h" 3 4
typedef unsigned int size_t;
# 526 "c:\\program files\\microchip\\xc32\\v4.60\\pic32c\\include\\musl\\bits\\alltypes.h" 3 4
typedef struct __locale_struct * locale_t;
# 24 "c:\\program files\\microchip\\xc32\\v4.60\\pic32c\\include\\musl\\string.h" 2 3 4
...
# 50 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 2
# 1 "../src/config/sama5d29_curiosity/system/time/sys_time.h" 1
# 63 "../src/config/sama5d29_curiosity/system/time/sys_time.h"
...
# 64 "../src/config/sama5d29_curiosity/system/time/sys_time.h" 2
# 1 "c:\\program files\\microchip\\xc32\\v4.60\\pic32c\\include\\musl\\stdbool.h" 1 3 4
# 65 "../src/config/sama5d29_curiosity/system/time/sys_time.h" 2
...
# 61 "../src/config/sama5d29_curiosity/system/int/sys_int.h"
...
# 62 "../src/config/sama5d29_curiosity/system/int/sys_int.h" 2
...
# 51 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 2

# 1 "../src/config/sama5d29_curiosity/system/time/src/sys_time_local.h" 1
# 54 "../src/config/sama5d29_curiosity/system/time/src/sys_time_local.h"
...
# 63 "../src/config/sama5d29_curiosity/osal/osal_impl_basic.h"
...
int clearenv(void);
# 64 "../src/config/sama5d29_curiosity/osal/osal_impl_basic.h" 2
...
# 55 "../src/config/sama5d29_curiosity/system/time/src/sys_time_local.h" 2
# 95 "../src/config/sama5d29_curiosity/system/time/src/sys_time_local.h"
typedef struct SYS_TIME_TIMER_OBJ_T{
      
# 96 "../src/config/sama5d29_curiosity/system/time/src/sys_time_local.h" 3 4
     _Bool 
# 96 "../src/config/sama5d29_curiosity/system/time/src/sys_time_local.h"
                                   inUse;
      
# 97 "../src/config/sama5d29_curiosity/system/time/src/sys_time_local.h" 3 4
     _Bool 
# 97 "../src/config/sama5d29_curiosity/system/time/src/sys_time_local.h"
                                   active;
      SYS_TIME_CALLBACK_TYPE type;
      ...
      uintptr_t context;
      volatile 
# 103 "../src/config/sama5d29_curiosity/system/time/src/sys_time_local.h" 3 4
              _Bool 
# 103 "../src/config/sama5d29_curiosity/system/time/src/sys_time_local.h"
                                   tmrElapsedFlag;
      volatile 
# 104 "../src/config/sama5d29_curiosity/system/time/src/sys_time_local.h" 3 4
              _Bool 
# 104 "../src/config/sama5d29_curiosity/system/time/src/sys_time_local.h"
                                   tmrElapsed;
...
# 122 "../src/config/sama5d29_curiosity/system/time/src/sys_time_local.h" 3 4
   _Bool 
# 122 "../src/config/sama5d29_curiosity/system/time/src/sys_time_local.h"
                                   hwTimerIntStatus;
    SYS_TIME_TIMER_OBJ* tmrActive;

    OSAL_MUTEX_HANDLE_TYPE timerMutex;

} SYS_TIME_COUNTER_OBJ;
# 53 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 2
...
static SYS_TIME_TIMER_OBJ timers[(5)];
...
static 
# 89 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
      _Bool 
# 89 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
           SYS_TIME_ResourceLock(void)
{
    ...
    if (gSystemCounterObj.interruptNestingCount == 0U)
    {
        ...
        if(OSAL_MUTEX_Lock(&gSystemCounterObj.timerMutex, (OSAL_TICK_TYPE)~0UL) == OSAL_RESULT_SUCCESS)
        {
            gSystemCounterObj.hwTimerIntStatus = SYS_INT_SourceDisable(gSystemCounterObj.hwTimerIntNum);
            return 
# 104 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                  1
# 104 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                      ;
        }
        else
        {
            ...
            return 
# 110 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                  0
# 110 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                       ;
        }
    }
    ...
    return 
# 117 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
          1
# 117 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
              ;
}
...
{
    SYS_TIME_TIMER_OBJ* timerObj = (SYS_TIME_TIMER_OBJ*)
# 135 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                                                       ((void*)0)
# 135 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                                                           ;

    if ((handle != ((SYS_TIME_HANDLE) (-1))) && (handle != 0U))
    {

        if ((handle & (0x0000FFFFUL)) < (uint32_t)(5))
        {


            timerObj = &timers[handle & (0x0000FFFFUL)];


            if ((timerObj->tmrHandle == handle) && (timerObj->inUse == 
# 147 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                                                                      1
# 147 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                                                                          ))
            {
                return timerObj;
            }
    ...
    return 
# 153 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
          ((void*)0)
# 153 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
              ;
}
...
static void SYS_TIME_HwTimerCompareUpdate(void)
{
    ...
    if (tmrActive != 
# 165 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                    ((void*)0)
# 165 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                        )
    {
        if (tmrActive->relativeTimePending > ((4294967295U)>>1))
        {
            nextHwCounterValue = (uint64_t)counterObj->hwTimerCurrentValue + ((4294967295U)>>1);
        }
        else
        {
    ...
    {
        currHwCounterValue = (4294967295U) + currHwCounterValue;
    }
    ...
    if ((counterObj->hwTimerCompareValue & (4294967295U)) == 0U)
    {
...
static 
# 210 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
      _Bool 
# 210 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
           SYS_TIME_RemoveFromList(SYS_TIME_TIMER_OBJ* delTimer)
{
    SYS_TIME_COUNTER_OBJ* counter = (SYS_TIME_COUNTER_OBJ *)&gSystemCounterObj;
    SYS_TIME_TIMER_OBJ* tmr = counter->tmrActive;
    SYS_TIME_TIMER_OBJ* prevTmr = 
# 214 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                                 ((void*)0)
# 214 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                                     ;
    
# 215 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
   _Bool 
# 215 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
        isHeadTimerUpdated = 
# 215 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                             0
# 215 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
    ...
    while ((tmr != 
# 220 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                  ((void*)0)
# 220 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                      ) && (tmr != delTimer))
    {
        prevTmr = tmr;
        tmr = tmr->tmrNext;
    ...
    if (tmr == 
# 227 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
              ((void*)0)
# 227 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                  )
    {
    ...
    if (delTimer->tmrNext != 
# 233 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                            ((void*)0)
# 233 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                                )
    {
    ...
    if (prevTmr == 
# 241 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                  ((void*)0)
# 241 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                      )
    {
        counter->tmrActive = counter->tmrActive->tmrNext;
        isHeadTimerUpdated = 
# 244 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                            1
# 244 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                                ;
    }
    else
    {
    ...
    delTimer->tmrNext = 
# 252 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                       ((void*)0)
# 252 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                           ;
...
static 
# 257 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
      _Bool 
# 257 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
           SYS_TIME_AddToList(SYS_TIME_TIMER_OBJ* newTimer)
{
    uint64_t total_time = 0;
    SYS_TIME_COUNTER_OBJ* counter = (SYS_TIME_COUNTER_OBJ* )&gSystemCounterObj;
    SYS_TIME_TIMER_OBJ* tmr = counter->tmrActive;
    SYS_TIME_TIMER_OBJ* prevTmr = 
# 262 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                                 ((void*)0)
# 262 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                                     ;
    uint32_t newTimerTime;
    
# 264 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
   _Bool 
# 264 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
        isHeadTimerUpdated = 
# 264 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                             0
# 264 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
    ...
    if (newTimer == 
# 266 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                   ((void*)0)
# 266 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                       )
    {
        return isHeadTimerUpdated;
    }
    ...
    if (tmr == 
# 273 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
              ((void*)0)
# 273 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                  )
    {
        ...
        isHeadTimerUpdated = 
# 278 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                            1
# 278 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                                ;
    }
    else
    {
        ...
        while (tmr != 
# 283 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                     ((void*)0)
# 283 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                         )
        {
        ...
        if (prevTmr == 
# 295 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                      ((void*)0)
# 295 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                          )
        {
            ...
            isHeadTimerUpdated = 
# 301 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                                1
# 301 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                                    ;
        }
        else
        {
        ...
        if (newTimer->tmrNext != 
# 311 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                                ((void*)0)
# 311 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                                    )
        {
...
static uint32_t SYS_TIME_GetElapsedCount(uint32_t hwTimerCurrentValue)
{
    ...
    {
        elapsedCount = ((4294967295U) - hwTimerPreviousValue) + hwTimerCurrentValue + 1U;
    }
...
static uint32_t SYS_TIME_GetTotalElapsedCount(SYS_TIME_TIMER_OBJ* tmr)
{
    ...
    if (tmr->active == 
# 351 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                      0
# 351 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                           )
    {
        elapsedCount = 0;
    }
    else
    {
        ...
        while ((tmrActive != 
# 358 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                            ((void*)0)
# 358 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                                ) && (tmrActive != tmr))
        {
...
# 393 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                             ((void*)0)
# 393 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                                 ;

    tmr = counterObj->tmrActive;

    while ((tmr != 
# 397 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                  ((void*)0)
# 397 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                      ) && (elapsedCount > 0U))
    {
...
# 420 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
   _Bool 
# 420 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
        isHeadTimerUpdated = 
# 420 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                             0
# 420 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
...
# 421 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
   _Bool 
# 421 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
        interruptState;
    ...
    if (isHeadTimerUpdated == 
# 435 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                             1
# 435 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                                 )
    {
        interruptState = SYS_INT_Disable();
...
static void SYS_TIME_ClientNotify(void)
{
    ...
    while (tmrActive != 
# 448 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                       ((void*)0)
# 448 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                           )
    {
        if(tmrActive->relativeTimePending == 0U)
        {
            tmrActive->tmrElapsedFlag = 
# 452 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                                       1
# 452 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                                           ;
            tmrActive->tmrElapsed = 
# 453 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                                   1
# 453 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                                       ;

            if ((tmrActive->type == SYS_TIME_SINGLE) && (tmrActive->callback != 
# 455 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                                                                               ((void*)0)
# 455 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                                                                                   ))
            {
            ...
            else
            {
                ...
                if (tmrActive->type == SYS_TIME_SINGLE)
                {
                    ...
                    tmrActive->active = 
# 468 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                                       0
# 468 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                                            ;
                }
            }

            if(tmrActive->callback != 
# 472 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                                     ((void*)0)
# 472 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                                         )
            {
...
static void SYS_TIME_UpdateTime(uint32_t elapsedCounts)
{
    ...
    for ( i = 0U; i < (uint32_t)(5); i++)
    {
# 506 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
        if (timers[i].tmrElapsed == 
# 506 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                                   1
# 506 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                                       )
        {
            timers[i].tmrElapsed = 
# 508 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                                  0
# 508 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                                       ;
...
# 525 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
   _Bool 
# 525 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
        interruptState;
    ...
    if (tmrActive != 
# 533 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                    ((void*)0)
# 533 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                        )
    {
...
{
    SYS_TIME_HANDLE tmrHandle = ((SYS_TIME_HANDLE) (-1));
    SYS_TIME_TIMER_OBJ *tmr;
    uint32_t tmrObjIndex = 0;

    if (SYS_TIME_ResourceLock() == 
# 559 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                                  0
# 559 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                                       )
    {
        return tmrHandle;
    }
    ...
    {
        for(tmr = timers; tmr < &timers[(5)]; tmr++)
        {
            if(tmr->inUse == 
# 567 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                            0
# 567 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                                 )
            {
                tmr->inUse = 
# 569 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                            1
# 569 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                                ;
                tmr->active = 
# 570 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                             0
# 570 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                                  ;
                tmr->tmrElapsedFlag = 
# 571 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                                     0
# 571 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                                          ;
                tmr->tmrElapsed = 
# 572 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                                 0
# 572 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                                      ;
                tmr->type = type;
...
static void SYS_TIME_CounterInit(SYS_MODULE_INIT* init)
{
    ...
    numerator = ((uint64_t)(2200) * counterObj->hwTimerFrequency);
    numeratorRead = (numerator/(uint64_t)(498000000)) + 2U;
    ...
    counterObj->hwTimerPeriodValue = (4294967295U);
    counterObj->hwTimerCompareValue = ((4294967295U)>>1);

    counterObj->swCounter64 = 0;
    counterObj->tmrActive = 
# 618 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                           ((void*)0)
# 618 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                               ;
    counterObj->interruptNestingCount = 0;

    counterObj->timePlib->timerCallbackSet(SYS_TIME_PLIBCallback, 0);
    if (counterObj->timePlib->timerPeriodSet != 
# 622 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                                               ((void*)0)
# 622 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                                                   )
    {
...
# 639 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
SYS_MODULE_OBJ SYS_TIME_Initialize( const SYS_MODULE_INDEX index, const SYS_MODULE_INIT * const init )
{
    if(init == 
# 641 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
              ((void*)0) 
# 641 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                   || index != (uint32_t)(0))
    {
...
# 708 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
   _Bool 
# 708 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
        interruptState;
...
# 732 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
   _Bool 
# 732 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
        interruptState;
...
)
{
    ...
    if ((type == SYS_TIME_SINGLE) && (callBack == 
# 778 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                                                 ((void*)0)
# 778 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                                                     ))
    {
        return ((SYS_TIME_HANDLE) (-1));
    }
...
{
    SYS_TIME_TIMER_OBJ *tmr = 
# 795 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                             ((void*)0)
# 795 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                                 ;
    SYS_TIME_RESULT result = SYS_TIME_ERROR;

    if (SYS_TIME_ResourceLock() == 
# 798 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                                  0
# 798 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                                       )
    {
        return result;
    }
    ...
    if ((type == SYS_TIME_SINGLE) && (callBack == 
# 804 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                                                 ((void*)0)
# 804 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                                                     ))
    {
        SYS_TIME_ResourceUnlock();
        return result;
    ...
    if((tmr != 
# 812 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
              ((void*)0)
# 812 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                  ) && (period > 0U) && (period >= count))
    {

        (void) SYS_TIME_RemoveFromList(tmr);
        tmr->tmrElapsedFlag = 
# 816 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                             0
# 816 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                                  ;
        tmr->tmrElapsed = 
# 817 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                         0
# 817 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                              ;
        tmr->type = type;
        tmr->requestedTime = period;
        tmr->relativeTimePending = period - count;
        ...
        tmr->active = 
# 831 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                     1
# 831 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                         ;
...
{
    SYS_TIME_TIMER_OBJ *tmr = 
# 841 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                             ((void*)0)
# 841 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                                 ;
    SYS_TIME_RESULT result = SYS_TIME_ERROR;

    if (SYS_TIME_ResourceLock() == 
# 844 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                                  0
# 844 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                                       )
    {
        return result;
    }
    ...
    if(tmr != 
# 851 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
             ((void*)0)
# 851 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                 )
    {
        if(tmr->active == 
# 853 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                         1
# 853 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                             )
        {
            (void) SYS_TIME_RemoveFromList(tmr);
            tmr->active = 
# 856 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                         0
# 856 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                              ;
        }
        tmr->tmrElapsedFlag = 
# 858 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                             0
# 858 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                                  ;
        tmr->tmrElapsed = 
# 859 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                         0
# 859 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                              ;
        tmr->inUse = 
# 860 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                    0
# 860 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                         ;
        result = SYS_TIME_SUCCESS;
    }
...
{
    SYS_TIME_TIMER_OBJ *tmr = 
# 870 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                             ((void*)0)
# 870 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                                 ;
    SYS_TIME_RESULT result = SYS_TIME_ERROR;

    if (SYS_TIME_ResourceLock() == 
# 873 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                                  0
# 873 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                                       )
    {
        return result;
    }
    ...
    if(tmr != 
# 880 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
             ((void*)0)
# 880 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                 )
    {
        if (tmr->active == 
# 882 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                          0
# 882 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                               )
        {
            ...
            tmr->tmrElapsedFlag = 
# 900 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                                 0
# 900 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                                      ;
            tmr->tmrElapsed = 
# 901 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                             0
# 901 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                                  ;
            tmr->active = 
# 902 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                         1
# 902 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                             ;
        }
        result = SYS_TIME_SUCCESS;
    }
...
{
    SYS_TIME_TIMER_OBJ *tmr = 
# 913 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                             ((void*)0)
# 913 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                                 ;
    SYS_TIME_RESULT result = SYS_TIME_ERROR;

    if (SYS_TIME_ResourceLock() == 
# 916 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                                  0
# 916 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                                       )
    {
        return result;
    }
    ...
    if(tmr != 
# 923 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
             ((void*)0)
# 923 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                 )
    {
        if (tmr->active == 
# 925 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                          1
# 925 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                              )
        {
            (void) SYS_TIME_RemoveFromList(tmr);
            tmr->tmrElapsedFlag = 
# 928 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                                 0
# 928 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                                      ;
            tmr->tmrElapsed = 
# 929 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                             0
# 929 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                                  ;
            tmr->active = 
# 930 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                         0
# 930 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                              ;
...
{
    SYS_TIME_TIMER_OBJ* tmr = 
# 943 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                             ((void*)0)
# 943 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                                 ;
    SYS_TIME_RESULT result = SYS_TIME_ERROR;
    uint32_t elapsedCount;

    if (SYS_TIME_ResourceLock() == 
# 947 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                                  0
# 947 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                                       )
    {
        return result;
    }
    ...
    if (count != 
# 952 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                ((void*)0)
# 952 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                    )
    {
        tmr = SYS_TIME_GetTimerObject(handle);
        if(tmr != 
# 955 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                 ((void*)0)
# 955 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                     )
        {
...
# 967 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
_Bool 
# 967 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
    SYS_TIME_TimerPeriodHasExpired(SYS_TIME_HANDLE handle)
{
    SYS_TIME_TIMER_OBJ* tmr = 
# 969 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                             ((void*)0)
# 969 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                                 ;
    
# 970 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
   _Bool 
# 970 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
        status = 
# 970 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                 0
# 970 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
    ...
    if (SYS_TIME_ResourceLock() == 
# 972 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                                  0
# 972 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                                       )
    {
        return status;
    }
    ...
    if(tmr != 
# 979 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
             ((void*)0)
# 979 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                 )
    {
        status = tmr->tmrElapsedFlag;

        tmr->tmrElapsedFlag = 
# 983 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                             0
# 983 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                                  ;
    }
...
SYS_TIME_RESULT SYS_TIME_DelayUS ( uint32_t us, SYS_TIME_HANDLE* handle )
{
    ...
    if ((handle == 
# 1000 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                  ((void*)0)
# 1000 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                      ) || (us == 0U))
    {
        return result;
    }

    *handle = SYS_TIME_TimerObjectCreate(0, SYS_TIME_USToCount(us), 
# 1005 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                                                                   ((void*)0)
# 1005 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                                                                       , 0, SYS_TIME_SINGLE);
    if(*handle != ((SYS_TIME_HANDLE) (-1)))
    {
...
SYS_TIME_RESULT SYS_TIME_DelayMS ( uint32_t ms, SYS_TIME_HANDLE* handle )
{
    ...
    if ((handle == 
# 1019 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                  ((void*)0)
# 1019 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                      ) || (ms == 0U))
    {
        return result;
    }

    *handle = SYS_TIME_TimerObjectCreate(0, SYS_TIME_MSToCount(ms), 
# 1024 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                                                                   ((void*)0)
# 1024 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                                                                       , 0, SYS_TIME_SINGLE);
    if(*handle != ((SYS_TIME_HANDLE) (-1)))
    {
       (void) SYS_TIME_TimerStart(*handle);
...
# 1034 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
_Bool 
# 1034 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
    SYS_TIME_DelayIsComplete ( SYS_TIME_HANDLE handle )
{
    
# 1036 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
   _Bool 
# 1036 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
        status = 
# 1036 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                 0
# 1036 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
    ...
    if(
# 1038 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
      1 
# 1038 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
           == SYS_TIME_TimerPeriodHasExpired(handle))
    {
        (void) SYS_TIME_TimerDestroy(handle);
        status = 
# 1041 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                1
# 1041 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                    ;
    }
...
{
    SYS_TIME_HANDLE handle = ((SYS_TIME_HANDLE) (-1));


    if ((type == SYS_TIME_SINGLE) && (callback == 
# 1058 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                                                 ((void*)0)
# 1058 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                                                     ))
    {
        return handle;
    }
...
SYS_TIME_HANDLE SYS_TIME_CallbackRegisterMS ( SYS_TIME_CALLBACK callback, uintptr_t context, uint32_t ms, SYS_TIME_CALLBACK_TYPE type )
{
    ...
    if ((type == SYS_TIME_SINGLE) && (callback == 
# 1080 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c" 3 4
                                                 ((void*)0)
# 1080 "../src/config/sama5d29_curiosity/system/time/src/sys_time.c"
                                                     ))
    {
        return handle;
    }
