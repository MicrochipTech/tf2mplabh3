# 1 "../src/config/sama5d29_curiosity/peripheral/clk/plib_clk.c"
...
# 1 "<command-line>"
# 1 "../src/config/sama5d29_curiosity/peripheral/clk/plib_clk.c"
# 24 "../src/config/sama5d29_curiosity/peripheral/clk/plib_clk.c"
...
# 25 "../src/config/sama5d29_curiosity/peripheral/clk/plib_clk.c" 2
# 1 "../src/config/sama5d29_curiosity/peripheral/clk/plib_clk.h" 1
# 27 "../src/config/sama5d29_curiosity/peripheral/clk/plib_clk.h"
...
# 28 "../src/config/sama5d29_curiosity/peripheral/clk/plib_clk.h" 2
...
# 26 "../src/config/sama5d29_curiosity/peripheral/clk/plib_clk.c" 2
# 34 "../src/config/sama5d29_curiosity/peripheral/clk/plib_clk.c"
void CLK_UTMIPLLEnable(void)
{

    ((pmc_registers_t*)0xf0014000)->CKGR_UCKR |= (((uint32_t)(0x1)) << ((uint32_t)(16)));


    while ((((pmc_registers_t*)0xf0014000)->PMC_SR & (((uint32_t)(0x1)) << ((uint32_t)(6)))) != (((uint32_t)(0x1)) << ((uint32_t)(6))))
    {
...
# 65 "../src/config/sama5d29_curiosity/peripheral/clk/plib_clk.c"
static void CLK_PeripheralClockInitialize(void)
{


    ((pmc_registers_t*)0xf0014000)->PMC_PCER0=0x1042000U;
    ((pmc_registers_t*)0xf0014000)->PMC_PCDR0=~0x1042000U;
    ((pmc_registers_t*)0xf0014000)->PMC_PCER1=0x8U;
    ((pmc_registers_t*)0xf0014000)->PMC_PCDR1=~0x8U;
}
# 82 "../src/config/sama5d29_curiosity/peripheral/clk/plib_clk.c"
void CLK_Initialize( void )
{
