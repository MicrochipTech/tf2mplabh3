# 1 "../src/config/sama5d29_curiosity/peripheral/pio/plib_pio.c"
...
# 1 "<command-line>"
# 1 "../src/config/sama5d29_curiosity/peripheral/pio/plib_pio.c"
# 44 "../src/config/sama5d29_curiosity/peripheral/pio/plib_pio.c"
# 1 "../src/config/sama5d29_curiosity/peripheral/pio/plib_pio.h" 1
# 45 "../src/config/sama5d29_curiosity/peripheral/pio/plib_pio.h"
...
# 46 "../src/config/sama5d29_curiosity/peripheral/pio/plib_pio.h" 2

# 1 "c:\\program files\\microchip\\xc32\\v4.60\\pic32c\\include\\musl\\stdbool.h" 1 3 4
# 48 "../src/config/sama5d29_curiosity/peripheral/pio/plib_pio.h" 2
...
# 49 "../src/config/sama5d29_curiosity/peripheral/pio/plib_pio.h" 2
...
# 45 "../src/config/sama5d29_curiosity/peripheral/pio/plib_pio.c" 2
...
# 46 "../src/config/sama5d29_curiosity/peripheral/pio/plib_pio.c" 2
# 59 "../src/config/sama5d29_curiosity/peripheral/pio/plib_pio.c"
void PIO_Initialize ( void )
{

   ((pio_group_registers_t*)(&(((pio_registers_t*)0xfc038000)->PIO_GROUP[0])))->PIO_MSKR = 0x100U;
   ((pio_group_registers_t*)(&(((pio_registers_t*)0xfc038000)->PIO_GROUP[0])))->PIO_CFGR = 0x0U;


   ((pio_group_registers_t*)(&(((pio_registers_t*)0xfc038000)->PIO_GROUP[0])))->PIO_MSKR = 0x80U;
   ((pio_group_registers_t*)(&(((pio_registers_t*)0xfc038000)->PIO_GROUP[0])))->PIO_CFGR = (((pio_group_registers_t*)(&(((pio_registers_t*)0xfc038000)->PIO_GROUP[0])))->PIO_CFGR & ((((uint32_t)(0x7)) << ((uint32_t)(0))))) | 0x100U;
   ...
   ((pio_group_registers_t*)(&(((pio_registers_t*)0xfc038000)->PIO_GROUP[0])))->PIO_MSKR = 0x200U;
   ((pio_group_registers_t*)(&(((pio_registers_t*)0xfc038000)->PIO_GROUP[0])))->PIO_CFGR = (((pio_group_registers_t*)(&(((pio_registers_t*)0xfc038000)->PIO_GROUP[0])))->PIO_CFGR & ((((uint32_t)(0x7)) << ((uint32_t)(0))))) | 0x100U;


   ((pio_group_registers_t*)(&(((pio_registers_t*)0xfc038000)->PIO_GROUP[0])))->PIO_MSKR = 0x20000U;
   ((pio_group_registers_t*)(&(((pio_registers_t*)0xfc038000)->PIO_GROUP[0])))->PIO_CFGR = (((pio_group_registers_t*)(&(((pio_registers_t*)0xfc038000)->PIO_GROUP[0])))->PIO_CFGR & ((((uint32_t)(0x7)) << ((uint32_t)(0))))) | 0x200U;


   ((pio_group_registers_t*)(&(((pio_registers_t*)0xfc038000)->PIO_GROUP[0])))->PIO_CODR = 0x100U;


   ((pio_group_registers_t*)(&(((pio_registers_t*)0xfc038000)->PIO_GROUP[1])))->PIO_MSKR = 0xc000000U;
   ((pio_group_registers_t*)(&(((pio_registers_t*)0xfc038000)->PIO_GROUP[1])))->PIO_CFGR = 0x3U;
# 95 "../src/config/sama5d29_curiosity/peripheral/pio/plib_pio.c"
}
# 125 "../src/config/sama5d29_curiosity/peripheral/pio/plib_pio.c"
uint32_t PIO_PortRead(PIO_PORT port)
{
    return ((pio_registers_t*)0xfc038000)->PIO_GROUP[port].PIO_PDSR;
}
# 141 "../src/config/sama5d29_curiosity/peripheral/pio/plib_pio.c"
void PIO_PortWrite(PIO_PORT port, uint32_t mask, uint32_t value)
{
    ((pio_registers_t*)0xfc038000)->PIO_GROUP[port].PIO_MSKR = mask;
    ((pio_registers_t*)0xfc038000)->PIO_GROUP[port].PIO_ODSR = value;
}
# 158 "../src/config/sama5d29_curiosity/peripheral/pio/plib_pio.c"
uint32_t PIO_PortLatchRead(PIO_PORT port)
{
    return ((pio_registers_t*)0xfc038000)->PIO_GROUP[port].PIO_ODSR;
}
# 174 "../src/config/sama5d29_curiosity/peripheral/pio/plib_pio.c"
void PIO_PortSet(PIO_PORT port, uint32_t mask)
{
    ((pio_registers_t*)0xfc038000)->PIO_GROUP[port].PIO_SODR = mask;
}
# 189 "../src/config/sama5d29_curiosity/peripheral/pio/plib_pio.c"
void PIO_PortClear(PIO_PORT port, uint32_t mask)
{
    ((pio_registers_t*)0xfc038000)->PIO_GROUP[port].PIO_CODR = mask;
}
# 204 "../src/config/sama5d29_curiosity/peripheral/pio/plib_pio.c"
void PIO_PortToggle(PIO_PORT port, uint32_t mask)
{

    ((pio_registers_t*)0xfc038000)->PIO_GROUP[port].PIO_MSKR = mask;
    ((pio_registers_t*)0xfc038000)->PIO_GROUP[port].PIO_ODSR ^= mask;
}
# 221 "../src/config/sama5d29_curiosity/peripheral/pio/plib_pio.c"
void PIO_PortInputEnable(PIO_PORT port, uint32_t mask)
{
    ((pio_registers_t*)0xfc038000)->PIO_GROUP[port].PIO_MSKR = mask;
    ((pio_registers_t*)0xfc038000)->PIO_GROUP[port].PIO_CFGR &= ~(((uint32_t)(0x1)) << ((uint32_t)(8)));
}
# 237 "../src/config/sama5d29_curiosity/peripheral/pio/plib_pio.c"
void PIO_PortOutputEnable(PIO_PORT port, uint32_t mask)
{
    ((pio_registers_t*)0xfc038000)->PIO_GROUP[port].PIO_MSKR = mask;
    ((pio_registers_t*)0xfc038000)->PIO_GROUP[port].PIO_CFGR |= (((uint32_t)(0x1)) << ((uint32_t)(8)));
