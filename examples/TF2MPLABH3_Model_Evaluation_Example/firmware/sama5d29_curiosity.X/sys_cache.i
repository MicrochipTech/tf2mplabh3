# 1 "../src/config/sama5d29_curiosity/system/cache/sys_cache.c"
...
# 1 "<command-line>"
# 1 "../src/config/sama5d29_curiosity/system/cache/sys_cache.c"
# 48 "../src/config/sama5d29_curiosity/system/cache/sys_cache.c"
...
# 49 "../src/config/sama5d29_curiosity/system/cache/sys_cache.c" 2
# 1 "../src/config/sama5d29_curiosity/system/cache/sys_cache.h" 1
# 55 "../src/config/sama5d29_curiosity/system/cache/sys_cache.h"
...
# 56 "../src/config/sama5d29_curiosity/system/cache/sys_cache.h" 2

# 1 "c:\\program files\\microchip\\xc32\\v4.60\\pic32c\\include\\musl\\stdbool.h" 1 3 4
# 58 "../src/config/sama5d29_curiosity/system/cache/sys_cache.h" 2
...
# 50 "../src/config/sama5d29_curiosity/system/cache/sys_cache.c" 2
# 60 "../src/config/sama5d29_curiosity/system/cache/sys_cache.c"
void SYS_CACHE_EnableCaches (void)
{
    icache_Enable();
    dcache_Enable();
...
void SYS_CACHE_InvalidateDCache_by_Addr (void *addr, int32_t size)
{
    dcache_InvalidateByAddr(addr,size);
}
...
void SYS_CACHE_CleanInvalidateDCache_by_Addr (void *addr, int32_t size)
{
    dcache_CleanInvalidateByAddr(addr,size);
}
